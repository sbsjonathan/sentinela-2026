(function () {
  const CONFIG = {
    apiKey: 'AIzaSyCcn4V2ikggM23uxmoGkXSslUzHanFJHH0',
    modelFallbacks:[
  ...
  window.gerarRespostaIA_Subtitulo = async function (idTrigger, wrapperElement, idRespostaIA) {
    ...
    try {
      ...
      respostaDiv.innerHTML = `<div class="ia-inline-note ia-status-error">Falha ao analisar esta seção: ${escapeHTML(error.message)}</div>`;
    } finally {
